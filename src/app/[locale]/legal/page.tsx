        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className={`md:w-80 md:flex-shrink-0 ${sidebarOpen ? 'block' : 'hidden md:block'}`}>
            <div className="sticky top-24">
                    ...
                    <div className="mb-4">
                      ...
                      {commonSidebarItems.map((item) => (
                        ...
                        >
                          ...
                          {currentPage === item.id && <div className="w-2 h-2 bg-white dark:bg-black rounded-full" />}
                        </Link>
                      ))}
                    </div>
              ...
              {/* Quick contact card */}
              <Card className="mt-6 bg-gradient-to-r from-teal-50 to-yellow-50 dark:from-gray-900 dark:to-teal-900/20 border-teal-200 dark:border-gray-700">
                <CardHeader>
...
export function LegalCard({ 
  ...
  const variantStyles = {
    ...
    warning: 'bg-teal-50 dark:bg-teal-950/20 border-teal-200 dark:border-teal-800',
