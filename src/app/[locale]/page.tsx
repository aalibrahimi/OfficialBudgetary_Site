...
export default function BudgetaryLandingPage({}: BudgetaryLandingPageProps) {
  ...
  // This how you reset the form's state.
  // Calling this outside of the "onSubmit" will also reset the "isSubmitSuccessful" state ?ali
  form.baseStore.subscribe((state) => {
    if (state.currentVal.isSubmitSuccessful) {
      setTimeout(() => {
        form.reset();
      }, 3000);
    }
  ...
  return (
      ...
      <section className="relative pt-4 pb-16 md:pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            {/* Compatibility Badge */}
            <div className="flex not-sm:flex-col items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 px-20">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="flex items-center justify-center w-12 h-12 mx-auto mb-3 bg-gradient-to-br from-teal-300/20 to-sky-400 dark:from-slate-800/20 dark:to-blue-900 rounded-xs border border-black/5 dark:border dark:border-white/10">
                  <div className="text-teal-700 dark:text-sky-500">
                    {stat.icon}
                  </div>
                </div>
          ...
          <div className="relative mx-auto max-w-6xl">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
              {/* Browser Header */}
              <div className="flex items-center justify-between p-4 bg-zinc-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="bg-gradient-to-br from-white to-zinc-200/50 dark:from-gray-800 dark:to-gray-700 p-4 rounded-xs border border-gray-200 dark:border-gray-600"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-gradient-to-br from-teal-100/50 to-sky-400/20 dark:from-slate-900/20 dark:to-blue-950/40 p-6 rounded-xs border border-teal-300 dark:border-teal-800">
                      <h3 className="font-semibold text-teal-900 dark:text-teal-100 mb-3">
                        Quick Add Expense
                      </h3>

                      {/* Success Message */}
                      {/* This is how you do "showSuccess" with tanstack form's listener ?ali */}
                      <form.Subscribe
                        ...
                        <form.Field
                          ...
                          children={(field) => (
                            <div>
                              ...
                              >
                                <SelectTrigger className="w-full rounded-xs border  border-teal-400 dark:border-teal-700 bg-white dark:bg-white/5">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="flex flex-col gap-1 text-4xl md:text-5xl font-bold mb-6">
              <span className="pb-2 bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-200 bg-clip-text text-transparent">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
                ...
                <div
                  ...
                  className={`cursor-pointer p-6 rounded-xs transition-all duration-300 ${
                    activeFeature === index
                      ...
                      : "bg-zinc-50 dark:bg-slate-900/50 hover:bg-white dark:hover:bg-gray-800 hover:shadow-md"
                  }`}
                  ...
                  <div className="flex items-start gap-4">
                    <div
                      className={`p-3 rounded-lg ${
                        activeFeature === index
                          ? "bg-gradient-to-br from-teal-300 to-teal-500/90 dark:from-teal-600 dark:to-teal-900 text-white"
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-teal-100/50 to-sky-400/20 dark:from-slate-900/20 dark:to-blue-950/40 border border-teal-200 dark:border-sky-950 p-8 rounded-2xl">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xs shadow-lg">
                  <div className="h-64 bg-gradient-to-br from-teal-100/50 to-sky-400/20 dark:from-slate-900/20 dark:to-blue-950/40 border border-teal-200 dark:border-white/10 rounded-lg flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <CardHeader>
                  <div className="w-12 h-12 bg-gradient-to-br from-teal-300/20 to-sky-400 dark:from-slate-800/20 dark:to-blue-900 rounded-xs border border-black/5 dark:border dark:border-white/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <div className="text-teal-700 dark:text-sky-500">
                      {feature.icon}
                    </div>
                  </div>
    ...
    {/* graphContent Section */}
            ...
            <Tabs defaultValue="connect" className="w-full">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={index} className="flex items-start gap-3">
                          <div className="w-6 h-6 rounded-full bg-gradient-to-br from-teal-300/80 to-teal-600 dark:from-teal-200/80 dark:to-teal-700 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div className="bg-gradient-to-br from-teal-100/50 to-sky-400/20 dark:from-slate-900/20 dark:to-blue-950/40 border border-teal-200 dark:border-sky-950 p-8 rounded-2xl">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3 p-3 bg-green-100/80 dark:bg-green-700/20 rounded-lg">
                          <Check className="w-5 h-5 text-green-600" />
                          <span className="text-sm">Chase Bank Connected</span>
                        </div>
                        <div className="flex items-center gap-3 p-3 bg-zinc-100 dark:bg-gray-700 rounded-lg">
              ...
              <TabsContent value="analyze" className="mt-8">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-700/20 dark:to-pink-700/20 border border-purple-200 dark:border-purple-950 p-8 rounded-2xl">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
                      <h4 className="font-semibold text-gray-900 dark:text-white mb-4">
                        Spending Analysis
                      </h4>
              ...
              <TabsContent value="optimize" className="mt-8">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="bg-gradient-to-br from-green-100 to-emerald-200 dark:from-green-600/20 dark:to-emerald-600/20 border border-green-300 dark:border-emerald-900 p-8 rounded-2xl">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
                      <h4 className="font-semibold text-gray-900 dark:text-white mb-4">
                        Financial Goals
                      </h4>
      ...
      {/* Enhanced CTA */}
      <section className="py-24 bg-gradient-to-br from-teal-500 via-cyan-500 to-blue-500 dark:via-cyan-600 dark:to-blue-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button
                size="lg"
                className="group bg-gradient-to-r from-teal-300 to-cyan-400 text-black shadow-lg hover:shadow-xl transition-all duration-300 px-8 py-4 text-lg"
              >
                <Download className="h-5 w-5 mr-2" />
                <a href="/downloads/Simplicity_0.1.0_x64-setup.exe" download>
                  Download Free Now
