    ...
    <div className="min-h-screen bg-white text-black dark:bg-[#000000] dark:text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-8">
          {/* Sidebar */}
          <div className={`md:w-80 md:flex-shrink-0 ${sidebarOpen ? 'block' : 'hidden md:block'}`}>
                ...
                <Card className="bg-gradient white dark:from-gray-900 dark:to-teal-900/20 border-gray-200 dark:border-gray-700">
                  ...
                  <CardContent>
                    <p className="text-gray-700 dark:text-gray-300 mb-4">
                      Budgetary is a personal finance application developed and operated by <strong>CodeWithAli</strong>, 
                      a technology company founded by Ali Alibrahimi (CEO & Owner) and Hanif Palm (Co-Founder & COO). 
                ...
                <div className="grid gap-6">
                  <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                    <CardHeader>
                      ...
                      <CardDescription>
                        When you connect your bank accounts, we access the following information through our secure integration with Plaid Inc.:
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                    ...
                    <CardContent>
                      <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                        <li><strong>Profile Information:</strong> Name, email address, and account preferences</li>
                        <li><strong>Budget Data:</strong> Budget categories and financial goals you set</li>
                        <li><strong>Usage Analytics:</strong> App usage patterns and feature preferences</li>
                        <li><strong>Support Records:</strong> Customer support interactions</li>
                      </ul>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-red-50 dark:bg-red-950/20 border-red-200 dark:border-red-800">
                    ...
                    <CardContent>
                      <ul className="list-disc list-inside space-y-2 text-black dark:text-red-300">
                        ...
                        <li>Any data unrelated to budgeting and expense tracking</li>
                      </ul>
                    </CardContent>
                  </Card>
                </div>
                  ...
                  <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                    ...
                    <CardContent>
                      <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                        ...
                        <li>Create personalized financial reports and trends</li>
                      </ul>
                    </CardContent>
                  </Card>
              ...
              <section id="data-security" className="mb-12">
                ...
                <div className="grid gap-6">
                  <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                    ...
                    <CardContent>
                      <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                        <li>All data stored in Supabase with enterprise-grade security</li>
                  ...
                  <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                    ...
                    <CardContent>
                      <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                        ...
                        <li><strong>Financial Data:</strong> Additional encryption layer with rotating keys</li>
                        <li><strong>Backup Data:</strong> Military-grade encryption standards</li>
                        <li><strong>API Communications:</strong> End-to-end encryption with Plaid and all third parties</li>
                      </ul>
                    </CardContent>
                  </Card>
                </div>
              ...
              <section id="third-party" className="mb-12">
                ...
                <div className="grid gap-6">
                  <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <p><strong>What they do:</strong> Securely connect your bank accounts to our app</p>
                        <p><strong>Data Shared:</strong> Account information and transaction history</p>
                        <p><strong>Security:</strong> Bank-level security, regulated by financial authorities</p>
                        <p><strong>Access Model:</strong> Read-only access, cannot move money or make transactions</p>
                        <div className="mt-4">
                          <a 
                          ...
                          >
                            View Plaid's Safety Page <ExternalLink className="h-3 w-3" />
                          </a>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <p><strong>What they do:</strong> Secure cloud database hosting for your data</p>
                        <p><strong>Data Stored:</strong> Encrypted user profiles and financial information</p>
                        <p><strong>Security:</strong> SOC 2 Type II compliant, GDPR compliant</p>
                        <p><strong>Location:</strong> Data centers with physical and digital security measures</p>
                        <div className="mt-4">
                          <a 
                          ...
                          >
                            View Supabase's Security Page <ExternalLink className="h-3 w-3" />
                          </a>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card className="bg-red-50 dark:bg-red-950/20 border-red-200 dark:border-red-800">
                    ...
                    <CardContent>
                      <ul className="list-disc list-inside space-y-2 text-red-700 dark:text-red-300">
                        ...
                        <li>Government agencies (except as required by law with proper warrants)</li>
                      </ul>
                    </CardContent>
                  </Card>
                </div>
              ...
              <section id="user-rights" className="mb-12">
                ...
                <div className="grid gap-6">
                  <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                    ...
                    <CardContent>
                      <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                        <li><strong>Download Your Data:</strong> Export all your financial data in standard formats</li>
                        <li><strong>Account Transparency:</strong> View all data we have about you</li>
                        <li><strong>Usage Logs:</strong> See when and how your data has been accessed</li>
                        <li><strong>Third-Party Connections:</strong> Manage which services can access your data</li>
                      </ul>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                    ...
                    <CardContent>
                      <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                        <li><strong>Granular Permissions:</strong> Choose which accounts to connect and sync</li>
                        <li><strong>Data Refresh Control:</strong> Manage how often we sync your financial data</li>
                        <li><strong>Feature Opt-out:</strong> Disable specific features that use your data</li>
                        <li><strong>Communication Preferences:</strong> Control all marketing and notification settings</li>
                      </ul>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-white dark:bg-white/20 border-teal-200 dark:border-teal-800">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div>
                          <h4 className="font-semibold mb-2">Account Termination Process:</h4>
                          <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300">
                            <li>Disconnection from all linked bank accounts and credit cards</li>
                            <li>Revocation of third-party financial services (e.g., Plaid)</li>
                            <li>Removal of budget categories and financial planning data</li>
                        ...
                        <div>
                          ...
                          <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300">
                            <li>Automated purging from primary databases via scheduled jobs</li>
                            <li>Deletion from encrypted backup systems</li>
                            <li>Cloud storage secure deletion with vendor confirmation</li>
              ...
              <section id="contact" className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <p className="flex items-center gap-2">
                          ...
                          <a href="mailto:budgetary@codewithali.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                            budgetary@codewithali.com
                          </a>
                        </p>
                        <p className="text-gray-600 dark:text-gray-400">
                          <strong>Response Time:</strong> Within 24 hours for security concerns
                        </p>
                        <p className="text-gray-600 dark:text-gray-400">
                          <strong>Emergency:</strong> Critical security issues receive immediate attention
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <p><strong>Ali Alibrahimi</strong><br />CEO & Owner</p>
                        <p className="flex items-center gap-2">
                          <Mail className="h-4 w-4" />
                          <a href="mailto:unfold@codewithali.com" className="text-green-600 dark:text-green-400 hover:underline">
                            unfold@codewithali.com
                          </a>
                        </p>
                        <p className="flex items-center gap-2">
                          <Mail className="h-4 w-4" />
                          <a href="mailto:privacy@codewithali.com" className="text-green-600 dark:text-green-400 hover:underline">
                ...
                <Card className="mt-6 bg-gradient-to-r from-teal-50 to-teal-50 dark:from-gray-900 dark:to-teal-900/20 border-teal-200 dark:border-gray-700">
                  ...
                  <CardContent>
                    <p className="text-gray-700 dark:text-gray-300 mb-4">
                      At <strong>CodeWithAli</strong>, we understand that your financial data is among the most sensitive 
                      information you possess. We are committed to earning and maintaining your trust through:
                    </p>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                      <li><strong>Transparent Communication:</strong> Clear, honest explanations of our practices</li>
                      <li><strong>Security Investment:</strong> Continuous improvement of our security infrastructure</li>
                      <li><strong>User Empowerment:</strong> Giving you control over your data and privacy</li>
                      <li><strong>Regulatory Excellence:</strong> Exceeding compliance requirements, not just meeting them</li>
                      <li><strong>Innovation with Responsibility:</strong> Building powerful features without compromising security</li>
                    </ul>
                    <div className="mt-4 p-4 bg-white dark:bg-gray-800 rounded-lg">
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        <strong>Remember:</strong> You can withdraw your consent and delete your account at any time 
